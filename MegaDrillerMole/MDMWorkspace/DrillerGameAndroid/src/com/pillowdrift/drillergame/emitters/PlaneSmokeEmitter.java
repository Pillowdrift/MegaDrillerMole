 ...
 *
 */
public class PlaneSmokeEmitter extends Emitter {

	public PlaneSmokeEmitter(Pool pool, GameScene parent)
	{	
		//Allow parent setup
		super(pool);
		...
		_minParticle._x = -64.0f;
		_minParticle._y = -16.0f;
		//MAX
		...
		_maxParticle._x = 64.0f;
		_maxParticle._y = -16.0f;
