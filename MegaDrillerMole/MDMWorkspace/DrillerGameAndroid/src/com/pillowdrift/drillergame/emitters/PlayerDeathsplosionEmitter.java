...
/**
 * Emitter for the explosion effect which occurrs on player's death
 * @author cake_cruncher_7
 *
 */
public class PlayerDeathsplosionEmitter extends Emitter
{
	...
	public PlayerDeathsplosionEmitter(Pool pool, GameScene parent)
	{
		super(pool);
