 ...
 *
 */
public class DemonCatBreathTrailEmitter extends Emitter {

	public DemonCatBreathTrailEmitter(Pool pool, GameScene parent)
	{	
		//Allow parent setup
		super(pool);
		...
		_minParticle._lifetime = 0.35f;
		_minParticle._alpha = 1.0f;
		_minParticle._dalpha = -1.0f/_minParticle._lifetime;
		_minParticle._gravityCo = 0.0f;
		_minParticle._texture = parent.getResourceManager().getAtlasRegion("atlas01", "demonCatBreath");
