...
public class WormExplosionEmitter extends Emitter {
	// Vars
	 ...
	 * @param parent
	 */
	public WormExplosionEmitter(Pool pool, GameScene parent)
	{
		super(pool);
		...
		_textures = new TextureRegion[] {
				parent.getResourceManager().getAtlasRegion("atlas01", "flesh1"),
				parent.getResourceManager().getAtlasRegion("atlas01", "flesh2"),
				parent.getResourceManager().getAtlasRegion("atlas01", "flesh3"),
		};
		...
		_maxParticle._gravityCo = 1.0f;
		_maxParticle._dx = 30.0f;
		_maxParticle._dy = 30.0f;
